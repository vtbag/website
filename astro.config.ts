  ...
  integrations: [
    ...
    sitemap({
      filter: (page) =>
        ...
        && !page.includes('-demo/')
        && !page.includes('-demo2/')
        && !page.startsWith('https://vtbag.dev/demo/')
        && !page.startsWith('https://vtbag.dev/demo-explainer/')
        && !page.startsWith('https://vtbag.dev/forge/')
        && !page.startsWith('https://vtbag.dev/hide-and-seek/list-')
        && !page.startsWith('https://vtbag.dev/inpection-chamber-demo/')
...
function sidebar() {
  return [
    ...
    {
      label: "Fun with View Transitions",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Flickering During Fade Animations?",
          link: "/tips/over-exposure/",
        },
      ...
      items: [
        {
          ...
          link: "/inspection-chamber-demo/first-page/",
        },
        ...
        {
          label: "Can't confine List Elements",
          link: "/basics/hide-and-seek/problem/",
        },
        {
