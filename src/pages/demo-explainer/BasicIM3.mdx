...
demoTitle: "View Transition Example: Clipped Overflow"
demoText: "This example shows how to prevent morphing view transitions between two different images from growing beyond the original size of the old and new images."
