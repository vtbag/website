...
demoTitle: "View Transition Example: Basic Image Morph"
demoText: "This example demonstrates the default morph animation between a small and a large version of the same image."
