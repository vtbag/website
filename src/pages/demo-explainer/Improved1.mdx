---
demoTitle: "View Transition Example: Improved Inline to Block Text Morph"
layout: "@/layouts/ExplainerLayout.astro"
demoText: "The 'repaired' version of the inline to block morph. Here the link and the heading are forced to share the same aspect ratio."
