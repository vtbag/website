...
demoTitle: "View Transition Example: Surprising Fade"
demoText: "This example highlights an unexpected issue that can arise from a simple typo. It took me some time to fully understand what was happening when I first encountered it. At first glance, this appears to be the standard image morph example.  However, instead of smoothly scaling into its larger version, the image fades gradually and then makes a sudden jump back at the end."
