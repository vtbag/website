...
demoTitle: "View Transition Example: Custom Animation, Page 1 of 2"
demoText: "A custom cross-document view transition animation that shrinks the old image on exit and enlarges the new image on entry."
