...
demoTitle: "View Transition Example: Basic Same-Document"
demoText: "This example demonstrates the default cross-over effect of view transitions. Press the brownish tab header to start the transition."
