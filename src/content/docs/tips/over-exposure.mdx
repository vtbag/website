---
title: Flashes during Fade Animations?
...
<div style="background-color: yellow">
  <img
    id="img"
    onclick="self.document.startViewTransition()"
    src="/landscape.webp"
    data-zoom-off
  />
</div>
