...
<details name="fail" class="c">
  ...
  It is best to place this rule together with your global view transition styles in a shared stylesheet and [include it on every page](/fwvt/enabling/#including-css-on-all-pages) .
