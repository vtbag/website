...
The View Transition API builds a [tree of pseudo-elements](/basics/pseudos/#the-theatre-curtain) that show images of elements from the before and after states. These pseudo-elements are what the view transition animations actually animates.
