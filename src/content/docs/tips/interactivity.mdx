...
Examples include the [Game of Life](/chaining-demo/), [Derived Trajectories](/vector-demo), and [Towers of Hanoi](https://fun-with-view-transitions.pages.dev/episode/7/page.html).
