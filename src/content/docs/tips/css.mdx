...
With Firefox currently supporting Level 1 view transitions only, this will break [because `:active-view-transition-type` is only available with Level 2 of the API](/basics/levels/#same-document-features-missing-in-level-1).
