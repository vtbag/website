...
Clipping the list elements at the list container prevents them from being drawn outside the list element. However, they seem to fly in front of the scrollbars.
