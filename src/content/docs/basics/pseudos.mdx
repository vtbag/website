...
|-|-|-| 
|`display`|`none`| &hellip;of the subtree, incl. its root| 
|`display`|`contents`|&hellip;of the element, only|
|`content-visibility`|`hidden`|&hellip;of the subtree excl. its root|
|`view-transition-scope`|`all`|&hellip;of the subtree from ancestors|
