...
Using `auto` with `id` can be used to define elements with the same view transition name for cross-document navigation. But dynamically generated names will always be different for two documents.
