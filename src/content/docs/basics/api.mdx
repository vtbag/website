...
2023-09-23| Scoped view transitions, where `startViewTransition()` can be called on DOM elements.|[Explainer: Scoped View Transitions](https://github.com/WICG/view-transitions/blob/main/scoped-transitions.md) |
