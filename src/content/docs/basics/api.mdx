...
|When|What|Where|
|---|---|---|
|2025-09-18|Support two phases for cross-document view transitions: instead of waiting for the new page to load before starting animations, begin them on the old page by hopping through quickly computable preview state for a smoother user experience. |[Explainer: Two-phase view transition](https://github.com/w3c/csswg-drafts/blob/main/css-view-transitions-2/two-phase-transition-explainer.md)
