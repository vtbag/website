...
* And even if you do not care about types yet, you can sill benefit from the fact that [mayStartViewTransition](/tools/utensil-drawer/#maystartviewtransition) also offers the Level 2 signature with options, even if the underlying API implementation does not. 
