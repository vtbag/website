...
You can also style other DOM elements that are not created by the View Transition API, but keep in mind that those elements are typically [hidden behind the view transition pseudo-elements](/basics/pseudos/#the-theatre-curtain) during a view transition.
