...
In current Chrome versions, `nested view transition groups` and `view-transition-name: auto` are available when you enable "Experimental Web Platform features" on `chrome://flags`.
