...
But **Good News**: There is a [polyfill for view transition types](/tools/utensil-drawer/#usetypespolyfill-always--never). For more on this pattern, check the [CSS Tips & Tricks](/tips/css/#scoping-with-types) section.
:::
