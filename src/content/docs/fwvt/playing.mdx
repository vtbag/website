...
You are curious about [`useTypesPolyfill: "always"`](/tools/utensil-drawer/#usetypespolyfill-always--never)? This has to do with the view transition type pattern that I recommend to structure view transition CSS rules. It has its own section [further down the page](#scoping-with-active-types).
