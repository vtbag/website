...
:::note[Edited]
Since I first published this episode, I made changes to the demo so it also works with Firefox once they release Level 1 view transitions. All changes have been tested with Firefox Nightly.
