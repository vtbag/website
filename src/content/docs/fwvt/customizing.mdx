...
If you want, you can compare your styles against the [sample solution](https://github.com/vtbag/fun-with-view-transitions/blob/main/episode/2/view-transition-solution.css).

Here is what it looks at [fun-with-view-transitions.pages.dev](https://fun-with-view-transitions.pages.dev/solved/2/page1.html) with those changes applied.
