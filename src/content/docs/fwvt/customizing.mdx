...
<EpisodeNav>
  ...
  <a class="selected" href="/fwvt/customizing/">Episode 2</a>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode2-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode2-light.mp4"
      autoplay
      loop
    />
  </span>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved2-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved2-light.mp4"
      autoplay
      loop
    />
  </span>
  <p slot="caption">Video showing view transitions as a smooth alternative to normal page load</p>
</Media>
