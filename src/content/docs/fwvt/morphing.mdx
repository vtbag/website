...
<EpisodeNav>
  ...
  <a class="selected" href="/fwvt/morphing/">
    Episode 3
  </a>
</EpisodeNav>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode3-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode3-light.mp4"
      autoplay
      loop
    />
  </span>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved3-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved3-light.mp4"
      autoplay
      loop
    />
  </span>
