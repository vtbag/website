...
<EpisodeNav>
  <a class="selected" href="/fwvt/enabling/">Episode 1</a>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode1-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/episode1-light.mp4"
      autoplay
      loop
    />
  </span>
...
<Media>
  <span class="not-content light:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved1-dark.mp4"
      autoplay
      loop
    />
  </span>
  <span class="not-content dark:sl-hidden">
    <video
      src="http://fun-with-view-transitions.pages.dev/videos/solved1-light.mp4"
      autoplay
      loop
    />
  </span>
