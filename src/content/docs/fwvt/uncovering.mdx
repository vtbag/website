...
If you're up for the challenge, a minimalistic reproduction awaits at [fun-with-view-transitions.pages.dev](fun-with-view-transitions.pages.dev) (Episode 6).
