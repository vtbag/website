...
description: Embark on a journey into the marvellous land of the View Transition API.
head:
  - tag: meta
    attrs:
      property: "og:image"
...
<div id="intro">
  ...
  <div id="intro-text">
    ...
    and fluent page updates can turn your site from _meh_ to _marvellous_.
