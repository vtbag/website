...
renderBlocking: "#await-page-content"
head:
  - tag: meta
    attrs:
      property: "og:image"
...
As a result, when the upper edge of the `<main>` section is scrolled out of view, the search bar appears to be hidden, making it look like the z-orders of layout are broken.
