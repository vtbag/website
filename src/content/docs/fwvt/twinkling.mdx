---
title: Add Native View Transitions to Your Starlight Site
...
**Get it all automatically  by installing the pre-configured**
<CTA>[Starlight plugin](https://events-3bg.pages.dev/library/StarlightPlugin/)</CTA> 
<style>{`#cta {margin-bottom: 1lh}`}</style>
**&hellip;or take the full walkthrough below!**
