...
data-vtbag-decl=`
  :is(h2, h3) = vtbag-h-;
  :is(starlight-toc span) = vtbag-toc~`>
```
This assigns `vtbag-h-0, ...` to the h2 and h3 headers of every page, and `vtbag-toc-0, ...` to the entries of the page navigation bar.
