...
You may see entries that do not have a checkmark but show a red dot instead. This means that the key frames of the animation could not be found. For details see the error message in the browser console.
