...
You may see entries that do not have a checkmark but show a red dot instead. This means that the key frames of the animation could not be found. A red dot instead of the list of animated properties indicates that there may be errors in the definition of the keyframes.
