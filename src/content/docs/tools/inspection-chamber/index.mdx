...
:::tip
If you want to use the Inspection Chamber with an Astro project, see [astro-vtbot](https://events-3bg.pages.dev/library/InspectionChamber/) for instructions. In Astro, the Chamber can be opened from the devToolbar!
:::
