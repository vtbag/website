...
Inspection Chamber requires a current browser with native support for the View Transition API.

For some older versions of Chrome it might be necessary to manually activate chrome://flags/#view-transition-on-navigation-iframe.
:::
...
![Modes of Operation](@/assets/inspection-chamber/dark-modes.png)
</span><span class="dark:sl-hidden">
![Modes of Operation](@/assets/inspection-chamber/light-modes.png)
...
![Full Control panel](@/assets/inspection-chamber/dark-full-control.png)
</span><span class="dark:sl-hidden">
![Full Control panel](@/assets/inspection-chamber/light-full-control.png)
</span></div><div style="margin-top:0">
...
![The name panel](@/assets/inspection-chamber/dark-names.png)
</span><span class="dark:sl-hidden">
![The name panel](@/assets/inspection-chamber/light-names.png)
</span></div><div style="margin-top:0">
...
During view transitions, the name list shows a purplish square to the left and/or a greenish square to the right of a name if the group has a old-image (purplish) and/or a new-image (greenish). If the images are outside of the viewport, the color changes to a shade of orange. You can click those squares to hide/unhide the images on the page. This can be particularly useful when you want to examine details of crowded areas of the page.
</div></div>
...
Each of the pseudo-elements introduced by the view transition API may feature multiple animations, either automatically generated by the View Transition API, defined by your CSS, or started via JavaScript on fulfilment of the `viewTransition.ready` promise. Here, you can see them all. Dive into the details or disable specific animations to understand how each one contributes to the overall effect.
<div class="light:sl-hidden">
![Animation panel](@/assets/inspection-chamber/dark-animation.png)
</div><div class="dark:sl-hidden">
![Animation panel](@/assets/inspection-chamber/light-animation.png)
</div>
...
![The filter panel](@/assets/inspection-chamber/dark-filter.png)
</span><span class="dark:sl-hidden">
![The filter panel](@/assets/inspection-chamber/light-filter.png)
</span></div><div style="margin-top:0">
