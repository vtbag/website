/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3935ac89af21bc3c1a07ead3c6a6f1b)
// Runtime types generated with workerd@1.20260603.1 2026-04-22 
interface __BaseEnv_Env {
	CHUNK_KV: KVNamespace;
	MY_SEARCH: AiSearchNamespace;
	AI: Ai;
	INSTANCE_ID: "crimson-hall-5fc7";
	GATEWAY_ID: "default";
	ACCOUNT_ID: "93976b094538bc1a55f9c7bc9100f75e";
	LOCAL: "true";
	API_TOKEN: string;
	AI_GATEWAY: string;
	GROQ_TOKEN: string;
	AI_STUDIO: string;
	JOURNAL_DO: DurableObjectNamespace<import("./src/vitras/chat").Journal_DO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/vitras/chat");
		durableNamespaces: "Journal_DO";
	}
